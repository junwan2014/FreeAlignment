...
class MaskFormerAFLWMapper:
    ...
    def __init__(
        ...
        *,
        ...
        self.flip = flip
        self.landmark_boundary_aflw = landmark_boundary_aflw
    ...
    def from_config(cls, cfg, is_train=True, modes = None):
        ...
        ret = {
            ...
            'landmark_boundary_aflw': cfg.DATASETS.LANDMAKR_BOUNDARY_AFLW,
    ...
    def __call__(self, dataset_dict):
        ...
        box_size = dataset_dict["box_size"]
        scale *= 1.25
        nparts = pts.shape[0]

        r = 0
        dataset_dict["meta"] = 'AFLW_train'
        if self.is_train:
        ...
        if self.is_train and self.modes == 'prompt':
            ...
            boundary_index = self.landmark_boundary_aflw[iidx]
            ...
            if not self.is_train:
                dataset_dict["meta"] = 'AFLW_val'
            classes = []
            masks = []
            sto_maps = []
            for iidx in range(num_boundary): #[0, 7]
                boundary_index = self.landmark_boundary_aflw[iidx]
                bound_land_num = len(boundary_index)
        ...
        dataset_dict['task'] = 'AFLW'
        dataset_dict['instances'] = instances
        dataset_dict['box_size'] = box_size
        return dataset_dict
