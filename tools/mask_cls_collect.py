...
def main(gt_dir, map_file_save_path, ignore_index=[255], ext=".png", recursive=False):
    # gt_dir = 'E:/datasets/COCO/freeseg/stuffthingmaps_detectron2/train2017_base'
    # map_file_save_path = 'E:/datasets/COCO/freeseg/stuffthingmaps_detectron2/train2017_base_label_count.json'
...
if __name__ == "__main__":
    ...
    # gt_dir = 'E:/datasets/COCO/freeseg/stuffthingmaps_detectron2/train2017_base'
    # map_file_save_path = 'E:/datasets/COCO/freeseg/stuffthingmaps_detectron2/train2017_base_label_count.json'
    # main(gt_dir, map_file_save_path)
