...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "coco_2017_train_panoptic": (
        ...
        "coco/freeseg//panoptic_train2017",
        "coco/freeseg/anotations/panoptic_train2017.json",
        # This directory contains semantic annotations that are
        # converted from panoptic annotations.
        # It is used by PanopticFPN.
        # You can use the script at detectron2/datasets/prepare_panoptic_fpn.py
        # to create these directories.
        "coco/freeseg/panoptic_semseg_train2017",
    ),
    "coco_2017_val_panoptic": (
        "coco/freeseg/panoptic_val2017",
        "coco/freeseg/annotations/panoptic_val2017.json",
        "coco/freeseg/panoptic_semseg_val2017",
    ),
}
...
def register_all_coco_panoptic_annos_sem_seg(root):
    for (prefix, (panoptic_root, panoptic_json, semantic_root),) in _PREDEFINED_SPLITS_COCO_PANOPTIC.items():
        ...
        image_root = 'E:/datasets/COCO/freeseg/images/all/'

        if prefix_instances=='coco_2017_val':
            instances_json = 'E:/datasets/COCO/freeseg/images/annotations/instances_val2017.json'
        else:
            instances_json = 'E:/datasets/COCO/freeseg/images/annotations/instances_train2017.json'
