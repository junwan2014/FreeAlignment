...
def crop_with_mask(
    ...
    _, h, w = image.shape
    # img_tmp = image.permute(1, 2, 0).int().cpu().numpy()
    # plt.imshow(img_tmp)
    # plt.show()
    ...
    # new_img_tmp = new_image.permute(1, 2, 0).int().cpu().numpy()
    # plt.imshow(new_img_tmp)
    # plt.show()

    # fin_imge = image[:, t:b, l:r] * mask[None, t:b, l:r]+ (1 - mask[None, t:b, l:r]) * new_image
    # fin_imge_tmp = fin_imge.permute(1, 2, 0).int().cpu().numpy()
    # plt.imshow(fin_imge_tmp)
    # plt.show()
