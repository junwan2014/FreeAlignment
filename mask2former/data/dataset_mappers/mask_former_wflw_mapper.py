...
class MaskFormerWFLWMapper:
    ...
    def __init__(
        ...
        *,
        ...
        self.flip = flip
        self.landmark_boundary_wflw = landmark_boundary_wflw
    ...
    def from_config(cls, cfg, is_train=True, modes=None):
        ...
        ret = {
            ...
            'landmark_boundary_wflw': cfg.DATASETS.LANDMAKR_BOUNDARY_WFLW,
    ...
    def __call__(self, dataset_dict):
        ...
        # img_tmp = Image.open(dataset_dict["file_name"]).convert('RGB')
        # plt.imshow(img_tmp)
        # plt.show()
        ...
        if self.is_train and self.modes == 'prompt':
            ...
            # if boundary_name=='right contour':
            #     print('right contour')
            #     show_preds(img, tpts)
            boundary_index = self.landmark_boundary_wflw[iidx]
