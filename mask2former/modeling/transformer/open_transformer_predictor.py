...
class OpenTransformerPredictor(MultiScaleMaskedTransformerDecoder):
    ...
    def __init__(
        ...
        *,
        ...
        if self.mask_classification:
            self.class_embed = MLP(hidden_dim, embed_hidden_dim, embedding_dim, embed_layers)
            self.landmark_embed = MLP(hidden_dim, embedding_dim, land_classes, embed_layers)
            self.landmark_coors = MLP(hidden_dim, hidden_dim // 2, 2, embed_layers)
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["land_classes"] = cfg.MODEL.SEM_SEG_HEAD.LAND_CLASSES
